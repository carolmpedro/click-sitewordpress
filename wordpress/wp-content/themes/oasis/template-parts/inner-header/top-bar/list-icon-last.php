<li class="list-item no-gutters">
  <a href="<?php echo esc_url(\ColibriWP\Theme\View::getData( 'link_value' )); ?>" h-use-smooth-scroll="true" class="item-link no-gutters">
    <div class="d-flex h-col no-gutters align-items-lg-center align-items-md-center align-items-center list-item-text-wrapper">
      <div class="d-flex">
        <span class="h-svg-icon style-21-icon style-local-10-h23-icon">
  ...
  <div class="list-container-divider d-flex justify-content-lg-end justify-content-md-end justify-content-end" style="display: none;"></div>
