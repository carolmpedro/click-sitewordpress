...
<div data-colibri-component="dropdown-menu" role="navigation" h-use-smooth-scroll-all="true" data-colibri-id="12-h9" class="h-menu h-global-transition-all h-ignore-global-body-typography has-offcanvas-tablet h-menu-horizontal h-dropdown-menu style-9 style-local-12-h9 position-relative h-element <?php $component->printContainerClasses(); ?>">
  ...
  <div data-colibri-id="12-h10" class="h-mobile-menu h-global-transition-disable style-10 style-local-12-h10 position-relative h-element">
    <a data-click-outside="true" data-target="#offcanvas-wrapper-12-h10" data-target-id="offcanvas-wrapper-12-h10" data-offcanvas-overlay-id="offcanvas-overlay-12-h10" href="#" data-colibri-component="offcanvas" data-direction="right" data-push="false" title="<?php esc_attr_e('Menu','oasis'); ?>" class="h-hamburger-button">
                  ...
                  <div class="w-100 h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-start align-self-md-start align-self-start">
                    <div data-colibri-id="12-h15" class="d-flex align-items-center text-lg-center text-md-center text-center justify-content-lg-center justify-content-md-center justify-content-center style-14 style-local-12-h15 position-relative h-element">
                      <a rel="home" href="<?php echo esc_url(home_url()); ?>" h-use-smooth-scroll="true" class="d-flex align-items-center">
                        <span class="h-logo__text h-logo__text_h logo-text d-inline-block style-14-text style-local-12-h15-text">
